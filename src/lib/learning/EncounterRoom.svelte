...
<style>
  .encounter{--accent:#6154df;--accent-soft:#8f86f3;--danger:#c8455f;--gold:#d6a33a;min-height:calc(100vh - 74px);position:relative;overflow:hidden;padding:22px clamp(20px,4vw,62px) 42px;background:linear-gradient(135deg,#0b1020 0%,#111827 55%,#0a0e18 100%);color:#f8fafc;font-family:Inter,system-ui,sans-serif}.encounter.boss{--accent:#9b4fe3;--accent-soft:#d17cff;--danger:#ed526c;background:linear-gradient(135deg,#160b22,#170d27 48%,#090711)}
  .map-ghost{position:absolute;inset:0;background:linear-gradient(90deg,rgba(8,12,23,.93),rgba(9,13,24,.83)),url('/assets/expedition-map.webp') center/cover no-repeat;opacity:.36;filter:saturate(.65) contrast(1.06)}.boss .map-ghost{filter:hue-rotate(205deg) saturate(.65) contrast(1.05)}
  ...
  .room-identity{position:relative;z-index:2;display:grid;grid-template-columns:auto 1fr auto;gap:18px;align-items:center;margin:8px 0 18px}.badge-wrap{width:76px;height:76px;display:grid;place-items:center}.badge-wrap img{width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 14px 20px rgba(0,0,0,.38))}.identity-copy>span,.eyebrow{font-size:9px;letter-spacing:.14em;color:var(--accent-soft);font-weight:800}.identity-copy h1{font-size:clamp(31px,4vw,50px);letter-spacing:-.055em;line-height:.94;margin:6px 0 5px}.identity-copy p{font-size:12px;color:#91a0b7;margin:0}.part-progress{display:flex;align-items:center;gap:10px;margin-top:9px}.part-progress>span{font-size:7px;letter-spacing:.11em;color:#718096;font-weight:800}.part-progress>div{display:flex;gap:5px}.part-progress i{width:20px;height:3px;border-radius:999px;background:#303b4e}.part-progress i.done{background:#6254dd}.part-progress i.current{background:#9a8df6;box-shadow:0 0 10px rgba(154,141,246,.35)}.belief-chip{min-width:112px;text-align:right;border-left:1px solid rgba(148,163,184,.2);padding-left:18px}.belief-chip small,.belief-chip b{display:block}.belief-chip small{font-size:8px;letter-spacing:.11em;color:#718096}.belief-chip b{font-size:28px;letter-spacing:-.04em;color:#fff}
  .encounter-surface{position:relative;z-index:2;width:min(1320px,100%);margin:0 auto;border:1px solid rgba(148,163,184,.2);border-radius:18px;background:linear-gradient(145deg,rgba(15,23,42,.93),rgba(12,18,32,.84));box-shadow:0 34px 90px rgba(0,0,0,.34);overflow:hidden;backdrop-filter:blur(18px)}
  .cinema{display:grid;grid-template-columns:minmax(0,1.7fr) minmax(310px,.7fr);min-height:580px}.frame-wrap{padding:18px;background:#060a12}.frame-label{height:34px;display:flex;align-items:center;justify-content:space-between;color:#718096;font-size:8px;letter-spacing:.1em}.frame-label span{color:var(--accent-soft);font-weight:800}.frame{position:relative;aspect-ratio:16/9;background:#000;border-radius:11px;overflow:hidden;box-shadow:0 16px 50px rgba(0,0,0,.48)}.frame iframe{position:absolute;inset:0;width:100%;height:100%;border:0}.mission-brief{padding:38px;display:flex;flex-direction:column;justify-content:center;border-left:1px solid rgba(148,163,184,.16)}.mission-brief h2{font-size:28px;line-height:1.08;letter-spacing:-.04em;margin:10px 0 14px}.mission-brief>p{font-size:12px;line-height:1.7;color:#a8b4c6}.source-meta{margin:18px 0;padding:12px 0;border-block:1px solid rgba(148,163,184,.16)}.source-meta span,.source-meta b{display:block}.source-meta span{font-size:8px;color:#6f7c90;text-transform:uppercase;letter-spacing:.1em}.source-meta b{font-size:10px;color:#cbd5e1;margin-top:4px;word-break:break-word}.human-lock{display:flex;gap:9px;align-items:flex-start;margin:6px 0 18px;padding:11px;border:1px solid rgba(214,163,58,.28);background:rgba(214,163,58,.07);border-radius:9px}.human-lock i{width:8px;height:8px;margin-top:3px;border-radius:50%;background:var(--gold);box-shadow:0 0 13px rgba(214,163,58,.6)}.human-lock span{font-size:9px;line-height:1.5;color:#d7c8a7}
  ...
  .quiz-room{display:grid;grid-template-columns:minmax(280px,.8fr) minmax(0,1.2fr);min-height:540px}.quiz-brief{padding:46px;border-right:1px solid rgba(148,163,184,.16);background:linear-gradient(160deg,rgba(97,84,223,.08),transparent 52%)}.quiz-brief h2{font-size:clamp(25px,3vw,40px);line-height:1.1;letter-spacing:-.045em;margin:14px 0 16px}.quiz-brief>p{font-size:11px;line-height:1.65;color:#96a3b7}.stakes{display:flex;gap:8px;flex-wrap:wrap;margin-top:24px}.stakes span{padding:8px 10px;border:1px solid rgba(148,163,184,.18);border-radius:8px;background:rgba(15,23,42,.64);font-size:8px;color:#8492a7}.stakes b{color:#fff}.options{padding:36px;display:flex;flex-direction:column;justify-content:center;gap:10px}.options button{display:grid;grid-template-columns:46px 1fr;align-items:center;text-align:left;border:1px solid rgba(148,163,184,.18);background:rgba(15,23,42,.62);color:#cbd5e1;border-radius:11px;overflow:hidden;cursor:pointer;transition:.16s}.options button:hover,.options button.selected{border-color:var(--accent-soft);background:rgba(97,84,223,.12);transform:translateX(3px)}.options button.right{border-color:#31b989;background:rgba(49,185,137,.1)}.options button.wrong{border-color:var(--danger);background:rgba(200,69,95,.1)}.letter{height:100%;display:grid;place-items:center;border-right:1px solid rgba(148,163,184,.16);font-size:12px;font-weight:800;color:var(--accent-soft)}.option-copy{padding:16px;font-size:11px;line-height:1.45}
  .recall-room{display:grid;grid-template-columns:minmax(320px,.92fr) minmax(0,1.08fr);min-height:500px}.brief{padding:36px;border-right:1px solid rgba(148,163,184,.16);background:linear-gradient(160deg,rgba(97,84,223,.08),transparent 50%)}.brief h2{font-size:clamp(24px,3vw,36px);line-height:1.13;letter-spacing:-.04em;margin:11px 0}.room-rule{font-size:10px;line-height:1.55;color:#7f8da2;margin:0 0 16px}.intel,.probe-list,.rubric{margin-top:11px;padding:11px;border:1px solid rgba(148,163,184,.17);background:rgba(7,12,22,.42);border-radius:10px}.intel>span,.probe-list>span,.rubric>span{display:block;font-size:8px;letter-spacing:.1em;color:#7f8ba0;font-weight:800}.intel p,.probe-list p{font-size:9px;line-height:1.55;color:#b4becd;margin:6px 0 0}.rubric>div{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:8px}.rubric b{padding:6px 7px;border:1px solid rgba(148,163,184,.14);border-radius:7px;font-size:8px;color:#aab4c4;font-weight:600}.answer-panel{padding:30px;display:flex;flex-direction:column}.answer-heading{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px}.answer-heading span{font-size:9px;letter-spacing:.12em;color:var(--accent-soft);font-weight:800}.answer-heading small{font-size:8px;color:#738096}.answer-panel textarea{flex:1;min-height:280px;width:100%;resize:none;border:1px solid rgba(148,163,184,.2);background:rgba(5,9,17,.65);border-radius:12px;color:#f1f5f9;padding:18px;font:12px/1.7 Inter,sans-serif;outline:none}.answer-panel textarea:focus{border-color:var(--accent-soft);box-shadow:0 0 0 3px rgba(97,84,223,.11),0 16px 40px rgba(0,0,0,.18)}.answer-footer{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:10px}.answer-footer>span{font-size:8px;color:#718096}.feedback{margin-top:11px;padding:11px 12px;border:1px solid rgba(49,185,137,.32);background:rgba(49,185,137,.08);border-radius:9px;color:#8de0bd;font-size:9px;line-height:1.5}.feedback.negative{border-color:rgba(200,69,95,.4);background:rgba(200,69,95,.08);color:#ffa4b5}
